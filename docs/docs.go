...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/players/delete": {
            "post": {
                "description": "Deletes a character via dune.delete_account: removes player\nactors, respawn beacons, and the account row, writes an audit\nlog entry, and notifies the live server. Irreversible.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "description": "Account ID and reason",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.ServerConfig"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/main.serverHealth"
                            }
                        }
                    }
                }
        ...
        "/api/v1/welcome-package/override": {
            "post": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    {
                        "description": "account_id, package_version",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        "main.ServerConfig": {
            ...
            "properties": {
                ...
                "broker_game_addr": {
                    "description": "Broker — RabbitMQ for capture / notification.",
                    "type": "string"
                },
                "broker_jwt_secret": {
                    "type": "string"
                ...
                "cmd_start": {
                    "description": "local-specific shell commands.",
                    "type": "string"
                },
                "cmd_status": {
                    "type": "string"
                ...
                "db_host": {
                    "description": "Database — always required per server.",
                    "type": "string"
                },
                "db_name": {
                    "type": "string"
                ...
                "ssh_host": {
                    "description": "Transport — SSH fields.",
                    "type": "string"
                },
                "ssh_key": {
                    "type": "string"
        ...
        "main.appConfig": {
            ...
            "properties": {
                ...
                "auto_discover": {
                    "description": "AutoDiscover: when true, fill empty DB/RMQ/Director fields from the\nrunning game-server process args at connect time (command-mode + kubectl).",
                    "type": "boolean"
                },
                "backup_dir": {
                ...
                "default_server_name": {
                    "description": "DefaultServerName is the display name of the legacy flat \"default\" server,\nso single-server installs can rename it. Blank → \"Default\".",
                    "type": "string"
                },
                "director_url": {
                    "type": "string"
        ...
        "main.welcomeConfigResponse": {
            ...
            "properties": {
                ...
                "region_chat_channel": {
                    "description": "\"whisper\" | \"map\"",
                    "type": "string"
                },
                "region_join_enabled": {
                    "type": "boolean"
                },
                "region_join_template": {
                    "type": "string"
                },
                "region_leave_enabled": {
                    "type": "boolean"
                },
                "region_leave_template": {
                    "type": "string"
                },
                "scan_interval_secs": {
                    "type": "integer"
