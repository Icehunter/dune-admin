...
export const SectionDivider: React.FC<SectionDividerProps> = ({ title, children }) => (
  <div className="flex items-center gap-3 border-t border-border pt-3 mt-3 shrink-0">
    <h3 className="text-base font-semibold text-accent flex-1 border-l-2 border-accent/60 pl-2">{title}</h3>
